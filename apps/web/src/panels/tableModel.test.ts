...
import { buildTableModel, type TableColumnInput } from "./tableModel";
...
// The row-at-or-before-cursor lookup now lives in `shared/cursorLookup.ts`
// and is covered by `cursorLookup.test.ts` (over both `bigint[]` and
// `BigInt64Array`).
